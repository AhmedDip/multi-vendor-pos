...
#[ObservedBy(ShippingMethodObserver::class)]
class ShippingMethod extends Model
{
    ...
    public function get_shipping_method(Request $request): LengthAwarePaginator
    {
        $query=self::query();
    ...
    public function store_shipping_method(Request $request){
        return self::query()->create($this->prepare_data($request));
    }

    public function update_shipping_method(Request $request, ShippingMethod $shipping_method){
        $shipping_method->update($this->prepare_data($request));
    }

    public function delete_shipping_method(ShippingMethod $shipping_method){
        $shipping_method->delete();
    }

    public function get_shipping_method_for_api(Request $request){
        return cache()->rememberForever('shipping_methods',function() use($request){
