...
<div class="col-md-6 mb-4">
    ...
    <i class="fas fa-tag"></i>
        {{html()->label('Feature Name', 'name')}}
        <x-required />
        {{html()->text('name')->class('form-control form-control-sm '. ($errors->has('name') ? 'is-invalid' : ''))->placeholder(__('Enter Feature name'))}}
...
<div class="col-md-6 mb-4">
    ...
    <i class="fas fa-link"></i>
        {{html()->label('Feature slug', 'slug')}}
        <x-required />
        {{html()->text('slug')->class('form-control form-control-sm '. ($errors->has('slug') ? 'is-invalid' : ''))->placeholder(__('Enter Feature slug'))}}
...
<div class="col-md-6 mb-4">
    ...
    <i class="fas fa-toggle-on"></i>
        ...
        <x-required />
        {{html()->select('status',\App\Models\Feature::STATUS_LIST)->class('form-select form-select-sm '. ($errors->has('status') ? 'is-invalid' : ''))->placeholder(__('Select Status'))}}
