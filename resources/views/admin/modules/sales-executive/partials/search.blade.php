{{ html()->form('GET', route('sales-executive.index'))->id('search_form')->open() }}
...
<div class="mb-4 row justify-content-center align-items-end">
    ...
    <div class="col-md-3">
        ...
        {{html()->text('name', $search['name'] ?? null)->class('form-control form-control-sm')->placeholder(trans('Ex. Sales Executive 1'))}}
    </div>
    <div class="col-md-3">
        <label for="email">{{ __('Enter Email') }}</label>
        {{html()->text('email', $search['email'] ?? null)->class('form-control form-control-sm')->placeholder(trans('Ex. sales.ex1@gmail.com'))}}
    </div>
