{{ html()->form('GET', route('product.index'))->id('search_form')->open() }}
...
<div class="mb-4 row justify-content-center align-items-end">
    ...
    <div class="col-md-3">
        ...
        {{html()->select('type', \App\Models\Product::TYPE_LIST, $search['type'] ?? null)->class('form-select form-select-sm')->placeholder('Select Type')}}
    </div>
    ...
    <div class="mt-2 col-md-8">
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="d-grid">
                    <a href="{{ route('product.export', $search) }}" class="btn btn-primary btn-sm" type="submit">
            ...
            <div class="col-md-3">
                <div class="d-grid">
                    <a href="{{ route('product.export-pdf', $search) }}" class="btn btn-danger btn-sm" type="submit">
