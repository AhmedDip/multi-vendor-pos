{{html()->form('get',route('membership-card.index'))->id('search_form')->open()}}
...
<div class="mb-4 row justify-content-center align-items-end">
    <div class="mb-4 col-md-4">
        {{html()->label(__('Enter Card No'), 'card_no')}}
        {{html()->text('card_no', $search['card_no'] ?? null)->class('form-control form-control-sm')->placeholder(__('Ex. 12345678'))}}
    </div>
    {{-- <div class="mb-4 col-md-4">
    ...
    <div class="mb-4 col-md-4">
        ...
        {{ html()->select('status', \App\Models\CustomerGroup::STATUS_LIST)->class('form-select form-select-sm ' . ($errors->has('status') ? 'is-invalid' : ''))->placeholder(__('Approval Status')) }}
