{{html()->form('get',route('expense.index'))->id('search_form')->open()}}
...
<div class="mb-4 row justify-content-center align-items-end">
    <div class="mb-4 col-md-4">
        {{html()->label(__('Enter Purpose'), 'purpose')}}
        {{html()->text('purpose', $search['purpose'] ?? null)->class('form-control form-control-sm')->placeholder(__('Ex. Dashboard'))}}
    </div>
    {{-- <div class="mb-4 col-md-4">
    ...
    <div class="mb-4 col-md-4">
        {{html()->label(__('Enter Amount'), 'amount')}}
        {{html()->number('amount', $search['amount'] ?? null)->class('form-control form-control-sm')->placeholder(__('Ex. 2000'))}}
    </div>
    <div class="mb-4 col-md-4">
