{{ html()->form('GET', route('discount.index'))->id('search_form')->open() }}
...
<div class="row justify-content-center mb-4 align-items-end">
    ...
    <div class="col-md-3">
        ...
        {{html()->select('status', \App\Models\Discount::STATUS_LIST, $search['status'] ?? null)->class('form-select form-select-sm')->placeholder(trans('Select Status'))}}
    </div>
