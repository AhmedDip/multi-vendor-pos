{{ html()->form('GET', route('shipping-method.index'))->id('search_form')->open() }}
...
<div class="row justify-content-center mb-4 align-items-end">
    ...
    <div class="col-md-3">
        ...
        {{html()->select('status', \App\Models\ShippingMethod::STATUS_LIST, $search['status'] ?? null)->class('form-select form-select-sm')->placeholder(trans('Select Status'))}}
    </div>
